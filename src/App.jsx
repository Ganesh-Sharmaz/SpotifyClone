...
function App() {
  ...
  return (
    <>
    <div className='grid relative bg-gradient-to-br from-pink-700 via-purple-600 to-purple-900 w-full  ' id="circles-container">
    
    
    <navbar>
      <header className=" fixed  w-full bg-black py-2 shadow-md">
        <div className="container mx-auto px-4  flex items-center">
          ...
          alt=""
          />
          <p className="text-xl md:text-4xl font-raleway font-bold text-white px-1">Groovy</p>
        </div>
        {/* search */}
      ...
      <nav className=" hidden md:block  ">
        <ul className=" px-3 flex items-center mr-4 lg:mr-6 xl:mr-8">
          ...
          <li className=' pt-2 pl-2'>
            <a href="https://github.com/Ganesh-Sharmaz/" className=" text-white  hover:text-sky-400 transition" >
            <button>
    ...
    <div className=" hidden md:block absolute w-72 h-72 bg-purple-900 opacity-5 rounded-full  animate-wiggle " style={{top: '20%', left: '20%' }}></div>

        {/* Circle 2 */}
        <div className="hidden md:block absolute w-64 h-64 bg-purple-400 opacity-5 rounded-full  animate-tiggle" style={{ top: '50%', left: '50%' }}></div>

    <div className=' mt-20 sm:mt-24 m-4 grid gap-3 grid-cols-1 sm:grid-cols-6'>
      ...
      <div className=' h-[300px] bg-red-400 rounded shadow-xl'>1</div>
      <div className=' h-[300px] bg-red-400 rounded shadow-xl'>2</div>
      <div className=' h-[300px] bg-red-400 rounded shadow-xl'>3</div>
      <div className=' h-[300px] bg-red-400 rounded shadow-xl'>1</div>
      <div className=' h-[300px] bg-red-400 rounded shadow-xl'>2</div>
      <div className=' h-[300px] bg-red-400 rounded shadow-xl'>3</div>
      <div className=' h-[300px] bg-red-400 rounded shadow-xl'>1</div>
